    ...
    return (
        <section className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-medium">Portfolio Snapshot</h2>
                <div className="text-sm text-gray-500">Total: ${total.toFixed(2)}</div>
            </div>
                        ...
                        {allocations.map((a) => (
                            <li key={a.symbol} className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500">${a.usdValue.toFixed(2)}</div>
                                </div>
                                <div className="text-sm text-gray-700">{a.percent.toFixed(2)}%</div>
                            </li>
                        ))}
                    </ul>
                </div>
